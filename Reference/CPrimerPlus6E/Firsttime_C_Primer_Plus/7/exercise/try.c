...
int main(void)
{
	...
	while( ( ch = tolower( getchar() )  ) != 'q') //tolower：大写转小写
	{
		switch(ch)
		{
			case 'a': printf("How many pounds of "
							  "artichokes do you want?");
					  scanf("%lf",&artichoke);
					  printf("Please select your vegetable"
							  ":a,b,c,q:");
					  continue;
			case 'b': printf("How many pounds of "
							  "beets do you want?");
					  scanf("%lf",&beet);
					  printf("Please select your v"
							  "egetable: a,b,c,q:");
					  continue;
			case 'c': printf("How many pounds of "
							  "carrots do you want?");
					  scanf("%lf",&carrot);
					  printf("Please select your veg"
							  "etable: a,b,c,q:");
					  continue;
			default: break;
		}
